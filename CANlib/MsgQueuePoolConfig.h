...
//const unsigned int techo = 0x101;

const unsigned int receivedMsgIDs[IN_QUEUES]={0x102,0x201,0x301};
const unsigned int receivedMsgDataLen[IN_QUEUES]={4,4,4};
//const unsigned int transmitedMsgIDs[OUT_QUEUES]={TECHO};
const unsigned int transmitedMsgIDs[OUT_QUEUES]={TECHO,0x202,0x302};
